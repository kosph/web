...
function canvash(str,canvas,initX,initY,lineHeight){
    var lineWidth = 0;
    var canvasWidth = canvas.width-100; 
    var lastSubStrIndex= 0; 
	    var ctx = canvas.getContext("2d"); 
...
function btClick(){
	...
	canvash('    “就这样被你征服，切断了所有退路”'+username+'想着心中的那个她，优哉游哉，辗转反侧，深夜时起来唱《征服》，歌声响彻复旦的整栋宿舍楼。唱到高音时突然破嗓，然后整栋楼都沸腾起来……',c,10,150,100);
